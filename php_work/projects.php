...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="margin-top: -500px;">
          <h1 class="page-header">Company Projects</h1>
          <p>This tab contains all the On-Going projects of this company</p>
        </div>
  </body>
</html>
